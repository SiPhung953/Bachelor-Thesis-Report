...
\begin{a3diagram}
	...
	\includegraphics[
	width=\AThreePrintableWidth,
	keepaspectratio
	]{diagrams/exported/ERD/Overview-ERD-crop.pdf}
	
	\vspace{8mm}
	
	\captionof{figure}{Overview Entity Relationship Diagram.}
	
	\label{diagram:erd-overview-test}
