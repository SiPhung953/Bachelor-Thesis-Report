...
\begin{itemize}
	\item The Job Seeker Application UI supports job application submission and status tracking.
	\item The Profile Management UI manages personal information, avatar, and resumes.
	\item The Employer Job Management UI supports company and job posting management.
	\item The Authentication UI handles login, registration, and role-based redirection.
	\item The Job Discovery UI supports job browsing and company profile viewing.
\end{itemize}
...
\begin{itemize}
	\item The Application Management components support the job seeker's workflow of applying and tracking.
	\item The Job Posting and Employer Application Management components provide employers with job publishing and application review capabilities.
