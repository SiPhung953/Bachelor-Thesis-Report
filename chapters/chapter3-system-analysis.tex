...
The following subsections present the role-specific use cases. In line with the scope defined in Section \ref{c3:section:proposed-system}, the Job Seeker and Employer roles are examined in detail as the two featured modules of this thesis, and the Back Office Worker role is presented as the moderation-supporting role.
